		...
		<div id="sidebar-left" class="col-xs-2 col-sm-2">
            ...
            <li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="ajax/page_adm_home.php">HOME</a></li>
						<li><a class="ajax-link" href="ajax/charts_flot.html">EMPRESA</a></li>
						<li><a class="ajax-link" href="ajax/charts_google.html">PRODUTOS</a></li>
						<li><a class="ajax-link" href="ajax/charts_morris.html">SERVIÇOS</a></li>
						<li><a class="ajax-link" href="ajax/charts_amcharts.html">CONTATOS</a></li>						
					</ul>
				</li>
